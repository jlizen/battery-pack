...
See [Templates](./templates.md#creating-a-new-project-from-a-template) for the full set of template options, including choosing specific templates, [non-interactive mode](./using.md#non-interactive-mode), and previewing output.
